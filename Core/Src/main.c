...
#define TASK_KEY3_ADAPTIVE_MOTION_DECI_CM_S 12L
...
#define TASK_KEY3_CAPTURE_BRAKE_ZONE_DECI_CM 15L
#define TASK_KEY3_CAPTURE_SPEED_LIMIT_DECI_CM_S 30L
#define TASK_KEY3_CAPTURE_BRAKE_BASE_PULSES 15L
#define TASK_KEY3_CAPTURE_BRAKE_GAIN_NUMERATOR 1L
#define TASK_KEY3_CAPTURE_BRAKE_LIMIT_PULSES 35L
